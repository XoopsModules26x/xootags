...
(function (a) {
    "use strict", a.fn.jQCloud = function (b, c) {
        var d = this, e = d.attr("id") || Math.floor(Math.random() * 1e6).toString(36), f = {
            width      : d.width(),
            height     : d.height(),
            center     : {x: (c && c.width ? c.width : d.width()) / 2, y: (c && c.height ? c.height : d.height()) / 2},
        ...
        var g = function () {
            ...
            var h = c.shape === "rectangular" ? 18 : 2, i = [], j = c.width / c.height, k = function (g, k) {
                ...
                k.html = a.extend(k.html, {id: l}), k.html && k.html["class"] && (s = k.html["class"], delete k.html["class"]), b[0].weight > b[b.length - 1].weight && (r = Math.round((k.weight - b[b.length - 1].weight) / (b[0].weight - b[b.length - 1].weight) * 9) + 1), u = a("<span>").attr(k.html).addClass("w" + r + " " + s), k.link ? (typeof k.link == "string" && (k.link = {href: k.link}), c.encodeURI && (k.link = a.extend(k.link, {href: encodeURI(k.link.href).replace(/'/g, "%27")})), t = a("<a>").attr(k.link).text(k.text)) : t = k.text, u.append(t);
